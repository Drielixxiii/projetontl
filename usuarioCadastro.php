                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <section class="col col-2">
                                                                ...
                                                                <label class="input">
                                                                    <input id="cpf" maxlength="64" name="cpf" type="password" class="required" value="">
                                                                </label>
                                                            </section>
                                                            <section class="col col-2">
                                                                <label class="label">Confirma cpf</label>
                                                                <label class="input">
                                                                    <input id="cpfConfirma" maxlength="64" name="cpfConfirma" type="password" class="required" value="">
                                                                </label>
                                                            </section>
                                                        </div>
                                                    </fieldset>
...
<script language="JavaScript" type="text/javascript">
    $(document).ready(function() {
        jQuery.validator.addMethod(
            ...
            function(value, element, params) {
                ...
                var cpfConfirma = $("#cpfConfirma").val();
        ...
        $('#formUsuario').validate({
            ...
            rules: {
                ...
                'cpfConfirma': {
                    confirmacpfRequerida: true,
                    confirmacpfequalto: true
                }
            },
            ...
            messages: {
                ...
                'cpf': {
                    ...
                    minlength: 'Digite no mínimo 7 caracteres',
                    cpfrequerida: 'Informe a cpf.'
                },
                'cpfConfirma': {
                    confirmacaocpfrequerida: 'Informe a cpf mais uma vez.',
                    confirmacaocpfequalto: 'Informe a mesma cpf digitada no campo cpf.'
                }
            },
    ...
    function gravar() {
        ...
        if (/^[a-zA-Z]*$/.test(Nome) === false) {
            smartAlert("Atenção", "O Nome não pode conter caracteres acentuados, numéricos e especiais.", "error");
            $("#Nome").focus();
            return;
        }
        ...
        if (id === 0) {
            if (cpf === "") {
                smartAlert("Atenção", "Informe a cpf.", "error");
                $("#cpf").focus();
                return;
            }

            if (/^[a-zA-Z0-9\!\#\$\&\*\-\+\?\.\;\,\:\]\[\(\)]*$/.test(cpf) === false) {
                smartAlert("Atenção", "A cpf não pode conter caracteres acentuados.", "error");
                $("#cpf").focus();
                return;
            }

            if (cpfConfirma === "") {
                smartAlert("Atenção", "Informe a confirmação de cpf.", "error");
                $("#cpfConfirma").focus();
                return;
            }

            if (cpf !== cpfConfirma) {
                smartAlert("Atenção", "Informe a confirmação de cpf igual a cpf.", "error");
                $("#cpfConfirma").focus();
                return;
            }
        } else {
        ...
        gravaUsuario(id, ativo, Nome, cpf, cpfConfirma, tipoUsuario);
    }
</script>